...
const Footer = () => {
  return (
    <footer className="w-full gradient-bg-footer text-white py-10 border-t border-pink-500/20">
      <div className="w-4/5 mx-auto grid grid-cols-1 md:grid-cols-3 gap-10">
        ...
        <div className="flex flex-col items-center md:items-end text-center md:text-right">
          ...
          <p className="text-gray-300 text-sm">
            Email: <span className="text-pink-400">support@hqnft.com</span>
          </p>
          <p className="text-gray-300 text-sm mt-1">
            Hotline: <span className="text-pink-400">0123 456 789</span>
          </p>
      ...
      <div className="border-t border-pink-500/20 mt-10 pt-4">
